...
# Calling the rosservices
    ...
    def wpPush(self,index,wps):
        ...
        try:
            ...
            print ("Waypoint has been Pushed")
        except rospy.ServiceException as e:
            print ("Service Pushing call failed: %s"%e)
    ...
    def wpPull(self,wps):
        ...
        try:
            ...
            print ("Waypoint has been Pulled")
        except rospy.ServiceException as e:
            print ("Service Pulling call failed: %s"%e)
...
def main():
    ...
    w = wayp3.setWaypoints(3,22,False,False,0.0,0.0,0.0,float('nan'),19.134423, 72.911763,10)
    wps.append(w)
